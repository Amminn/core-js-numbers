...
// divide each number by 2 first, then sum them, to prevent infinite error
 ...
 *   (0,1) (0,1)     => 0
 */
/** The goal is to calculate the angle (in radians) between these two vectors.
  - First vector: (x1, y1)
  - Second vector: (x2, y2)
*/
...
/**
  ...
  Step 3: Use the formula to find the angle (in radians)
  Step 4: Return the angle using Math.acos
 */
 ...
 *     0     => 0
 */
// The modulus operator % gives the remainder when dividing a number by 10. Since 10 is a base of the decimal system, the remainder when dividing by 10 is always the last digit of the number.
...
function getSumOfDigits(num) {
  ...
  return splitNum.reduce((a, b) => Number(a) + Number(b), 0);
}
